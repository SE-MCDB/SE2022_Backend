...
def send_email(email, code):
    ...
    msg.encoding = 'utf-8'
    # image = add_img(path_use + '/static/images/send_email.png', 'test_cid')
    # msg.attach(image)
    msg.send()
