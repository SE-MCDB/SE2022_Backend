# Generated by Django 2.2.3 on 2022-04-15 11:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.IntegerField(choices=[(0, '普通用户'), (1, '专家认证中'), (2, '企业认证中'), (3, '封禁中'), (4, '认证专家'), (5, '认证企业')], default=0)),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_license', models.ImageField(default='images/default_user_icon.jpg', upload_to='images/%Y%m/%d/icons')),
                ('legal_person_ID', models.ImageField(default='images/default_user_icon.jpg', upload_to='images/%Y%m/%d/icons')),
            ],
        ),
        migrations.CreateModel(
            name='Keyword',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field', models.IntegerField(choices=[(0, '信息技术'), (1, '装备制造'), (2, '新材料'), (3, '新能源'), (4, '节能环保'), (5, '生物医药'), (6, '科学创意'), (7, '检验检测'), (8, '其他')], default=8)),
                ('address', models.CharField(max_length=20)),
                ('state', models.IntegerField(choices=[(0, '进行中'), (1, '已结束')], default=0)),
                ('emergency', models.IntegerField(choices=[(0, '低'), (1, '中'), (2, '高')], default=0)),
                ('predict', models.IntegerField()),
                ('real', models.IntegerField(default=0)),
                ('enterprise', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='enterprise', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Paper',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.IntegerField(choices=[(0, '正在合作中'), (1, '合作结束')], default=0)),
                ('need', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='need', to='core.Need')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='enterprise_license', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Image',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='enterprise_id', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Chatroom',
        ...
        migrations.AddField(
            model_name='user',
            name='enterprise_info',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='enterprise_info', to='core.Enterprise_info'),
        ),
        migrations.AddField(
            model_name='user',
            name='favorites',
